...
using namespace io;
http_stream::http_stream(http_handle_t handle)
    : m_buffer_start(0), m_buffer_size(0), m_client(handle), m_position(0) {}
...
void* http_stream::handle() const { return m_client; }
...
int http_stream::putch(int value) { return 0; }
size_t http_stream::write(const uint8_t* data, size_t size) { return 0; }
